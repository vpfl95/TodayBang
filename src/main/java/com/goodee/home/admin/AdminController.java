...
public class AdminController {
	...
	@GetMapping("updateOperatorRank")
	@ResponseBody
	public int updateOperatorRank(MemberDTO memberDTO,Pager page,String action) throws Exception{
		
		
		int result = adminSerivece.updateMemberRank(memberDTO,action);
