...
function headerCategory(cate){
    ...
    if(cate == "storeMenu"){
        ...
        url = ['/store', '/category/main', '/todayDeals', '/exhibitions/detail?exhibitionCode=1433', '/exhibitions/detail?exhibitionCode=2181', '/exhibitions/detail?exhibitionCode=1763', '/exhibitions/main'];
