	...
	<div>
				...
				<form action="./join" method="post" id = "joinForm" >
		        		<div id = "joinInput">
					        ...
					        <input type="text" value ="${member.userId }" id="userId" name = "userId" class="form-control nonOverlab" placeholder="아이디" required autofocus>
				        ...
				        <button id="joinBtn" class="w-100 btn btn-lg btn-primary" type="submit">수정</button>
